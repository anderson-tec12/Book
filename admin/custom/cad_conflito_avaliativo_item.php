...
$registro = $oConn->describleTable("conflito_avaliativo_item");
...
if ($ispostback) {
    if ($id != "")
        $registro = connAccess::fastOne($oConn, "conflito_avaliativo_item", " id = " . $id);
...
if ($acao == "SAVE") {
    ...
    $registro["id"] = $bdConflitoAvaliativoItem->salvar($registro);
...
if ($acao == "DEL" && $id != "") {
    $registro = connAccess::fastOne($oConn, "conflito_avaliativo_item", " id = " . $id);
    connAccess::Delete($oConn, $registro, "conflito_avaliativo_item", "id");
...
<div class="row">
    <div class="col-xs-12">
        <h1 class="sistem-title">Cadastro de Item Avaliativo</h1>
