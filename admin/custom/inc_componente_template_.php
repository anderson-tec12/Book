...
class componente_template {
    ...
    static function InputCampo($item) {
        ...
        $tx = '';
        //echo($codigo. " ---- ");
        if ($codigo == "video" || $codigo == "texto" || $codigo == "texto-m" || $codigo == "texto-p") {
    ...
    public static function getComponenteTemplateByFerramenta($idFerramenta) {
        ...
        $sql = " select ct.*, ic.imagem as imagem01, ic2.imagem as imagem02 
             ...
             where id_ferramenta = " . $idFerramenta . " and coalesce(ct.status,'') not in ('rascunho') ";
