...
<form method="post" name="frm" action="index.php?pag=modulo&mod=<?php echo Util::request("mod") ?>">
    ...
    <div class="fieldBox">
        ...
        <? if (Util::request("exp_excel") == "") { ?>
            <div class="row">
                <div class="col-xs-12">
                    <h1 class="sistem-title">Módulo</h1>
                ...
                <div class="bs-example">
                    ...
                    <table class="table table-hover table-condensed"   <? if (Util::request("exp_excel") == "") { ?> border="0" <? } else { ?> border="1" <? } ?>	>
                        ...
                        <tbody>
                            ...
                            $sql = " select * from modulo p where 1 = 1 " . $filtro;
...
<script >
    function load(id)
    {
        ...
        f.action = "index.php?pag=modulo&mod=cad&acao=<?php echo Util::$LOAD ?>&id=" + id + "&tipo=<?= Util::request("tipo") ?>";
        f.submit();
    }
    ...
    function excluir(id)
    {
        ...
        var f = document.forms[0];
        f.action = "delete.php?pag=modulo&mod=cad&acao=<?php echo Util::$LOAD ?>&id=" + id + "&tipo=<?= Util::request("tipo") ?>";
        f.submit();
