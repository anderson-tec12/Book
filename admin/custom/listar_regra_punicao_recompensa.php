...
<form method="post" name="frm" action="index.php?pag=regra_punicao_recompensa&mod=<?php echo Util::request("mod") ?>">
    ...
    <div class="fieldBox">
        ...
        <? if (Util::request("exp_excel") == "") { ?>
            <div class="row">
                <div class="col-xs-12">
                    <h1 class="sistem-title">Regra de Punição e Recompensa</h1>
            ...
            <div class="col-xs-12">
                <div class="bs-example">
                    <div class="row">
                        ...
                        <? if (Util::request("exp_excel") == "") { ?>
                            <div class="col-xs-3">
                                <h4 class="sistem-subtitle">Lista de Regras</h4>
                            </div>
                    ...
                    <table class="table table-hover table-condensed"   <? if (Util::request("exp_excel") == "") { ?> border="0" <? } else { ?> border="1" <? } ?>	>
                        ...
                        <tbody>
                            ...
                            $sql = " select * from regra_punicao_recompensa p where 1 = 1 " . $filtro;
...
<script >
    function load(id)
    {
        ...
        f.action = "index.php?pag=regra_punicao_recompensa&mod=cad&acao=<?php echo Util::$LOAD ?>&id=" + id + "&tipo=<?= Util::request("tipo") ?>";
        f.submit();
    }
    ...
    function excluir(id)
    {
        ...
        var f = document.forms[0];
        f.action = "delete.php?pag=regra_punicao_recompensa&mod=cad&acao=<?php echo Util::$LOAD ?>&id=" + id + "&tipo=<?= Util::request("tipo") ?>";
        f.submit();
