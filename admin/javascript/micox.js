function ajaxGet(url,elemento_retorno,exibe_carregando, fn_finish ){
/******
...
*******/
   ...
   if(ajax1){
       ...
       if ( elemento_retorno != null ){
           if ( exibe_carregando != null && exibe_carregando != ""){
               put(exibe_carregando);
           }
   ...
   function ajaxOnReady(){
       if (ajax1.readyState==4){
           if(ajax1.status == 200){
               ...
               if ( fn_finish != null ){
                      fn_finish( texto,  elemento_retorno);
               }
               
           }else{
           
               if(exibe_carregando != null ){put("Falha no carregamento. " + httpStatus(ajax1.status));}
               			   
           
           }
           ajax1 = null
       }else if(exibe_carregando != null ){//para mudar o status de cada carregando
               put(exibe_carregando );
       }
   }
...
//AjaxPOST -- Igual ao GET Porém usa o formulário para gerar os para enviar..
function ajaxPost(url,elemento_retorno,exibe_carregando, fn_finish, formulario, continuacaoDados ){
/******
* ajaxGet - Coloca o retorno de uma url em um elemento qualquer
* Use a vontade mas coloque meu nome nos créditos. Dúvidas, me mande um email.
* A função é grande, coloque-a em um arquivo .js separado.
...
*******/
   ...
   if(ajax1){
       ...
       ajax1.send(formulario_conteudo+continuacaoDados)
       return true;
   }else{
       return false;
   }
