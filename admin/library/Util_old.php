<?php
 ...
 class  Util
 {
	...
	static function comboBoxJqueryComplete($nomeCombo , $mostraInclude = true){
		...
		<script>
				window.dhx_globalImgPath = "'.K_RAIZ .'javascript/htmlxcombo/imgs/";
				</script>
				
				<link rel="STYLESHEET" type="text/css" href="'.K_RAIZ .'javascript/htmlxcombo/dhtmlxcombo.css">
				<script  src="'.K_RAIZ .'javascript/htmlxcombo/dhtmlxcommon.js"></script>
				<script  src="'.K_RAIZ .'javascript/htmlxcombo/dhtmlxcombo.js"></script>';
  ...
  $cont = 0;
	...
	public static function mensagemCadastro($tam=95, $strvar = "st_Mensagem", $classe = "dvMensagem")
	{
	   ...
	   $_SESSION[$strvar] = "";
			...
			if ( $msg != "")
			{
				echo '<center><div style="test-align:center;width:'.$tam.'%" class="'.$classe.'">'.
					$msg.'</div></center>';
