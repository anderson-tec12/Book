...
Class resize
{
    ...
    public function resizeImage($newWidth, $newHeight, $option = "auto")
    {
        ...
        //Setando background transparente - Rodrigo Augusto - 19/11/2014
        imagesavealpha( $this->imageResized, true);
        $trans_colour = imagecolorallocatealpha( $this->imageResized, 0, 0, 0, 127);
        //$color = imagecolorallocate($this->imageResized, 255, 255, 255);
        imagefill($this->imageResized, 0, 0, $trans_colour);
