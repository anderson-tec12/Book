...
class AvaliacaoKappa implements IComponent {
    ...
    public function __construct($idKappa = "", $id_registro = "", $tabela = "", $componente_template = "", $classe = "") {
    ...
    public function printHTML() {
        ...
        <div class="container container-twelve">
            <div class="twelve columns">
                    ...
                    <tbody>
                        ...
                        if (empty($this->classe)) {
                            ...
                            <tr>
                                ...
                                <td rowspan="2" id="<?= $this->idKappa ?>_nota1"><a onclick="setNota(1, '<?= $this->idKappa ?>');"><img id="imgNota1_kappa<?= $this->idKappa ?>" src="<?= K_RAIZ ?>painel/images/botoes_kappa_1.png"/></a></td>
                                <td rowspan="3" id="<?= $this->idKappa ?>_nota2"><a onclick="setNota(2, '<?= $this->idKappa ?>');"><img id="imgNota2_kappa<?= $this->idKappa ?>"  src="<?= K_RAIZ ?>painel/images/botoes_kappa_2.png"/></a></td>
                                <td rowspan="4" id="<?= $this->idKappa ?>_nota3"><a onclick="setNota(3, '<?= $this->idKappa ?>');"><img id="imgNota3_kappa<?= $this->idKappa ?>"  src="<?= K_RAIZ ?>painel/images/botoes_kappa_3.png"/></a></td>
                                <td rowspan="5" id="<?= $this->idKappa ?>_nota4"><a onclick="setNota(4, '<?= $this->idKappa ?>');"><img id="imgNota4_kappa<?= $this->idKappa ?>"  src="<?= K_RAIZ ?>painel/images/botoes_kappa_4.png"/></a></td>
                                <td rowspan="6" id="<?= $this->idKappa ?>_nota5"><a onclick="setNota(5, '<?= $this->idKappa ?>');"><img id="imgNota5_kappa<?= $this->idKappa ?>"  src="<?= K_RAIZ ?>painel/images/botoes_kappa_5.png"/></a></td>
                            </tr>
                            <?
                        } else {
                            ?>
                            <tr>
                                <td rowspan="1"><img class="<?= $this->classe ?>_k" style="width: 98px;" src="<?= K_RAIZ ?>painel/images/botoes_kappa_k.png"/><a name="acapa"></a></td>
                ...
                if (empty($this->classe)) {
                    ?>
                    <div class="kappa_ressalva" id="div_ressalva_<?= $this->idKappa ?>" style="display:none">
