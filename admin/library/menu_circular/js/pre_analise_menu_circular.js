...
function clickAdicionar(idTemplateSelected) {
    ...
    if (textSelected !== undefined && textSelected !== "") {
        ...
        f.target = "frame_menu";
        f.action = "ferramentas/pre_analise/ajax_pre_analise_panel.php";
        f.submit();
...
function setSelectText(idElementSelect) {
    ...
    var checkUsarMenuCircular = document.getElementById("check_usar_menu_circular");

    if (checkUsarMenuCircular == undefined || checkUsarMenuCircular.checked) {
        //Apresenta o Menu Circular
        this.showPanel();
    }
