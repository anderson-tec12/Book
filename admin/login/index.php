...
//            $msg_temp = Parameters::getValue("msg_cadastro_ativado_email",$oConn );
//            if ( $msg_temp != ""){
//                $txt = $msg_temp;
//                
//                $txt = str_replace("{email}", $usuario["email"], $txt);
//                
//            }
            
            $msg_dados = "Obrigado por se cadastrar!|".$txt."|Saiba mais sobre o 1Acordo|/portal";
   ...
   if (! $usuario["id"]){
     ...
     if (! $usuario["verificado_email"] ){
       ...
       $login_email. ", porém não está ativo. É necessário clicar no link enviado no e-mail de confirmação. ";
            ...
            <form method="post" name="frmLogin"  action="index.php" id="tabela">
                ...
                <div id="div_login_botoes_grande">
                    <ul>
                        ...
                        <li>                
                            <input type="button" name="btLoginFacebookGrande" value="Cadastre-se com o Facebook" class="login_botao_facebook" onclick="fn_chamalogin(this)"/>
                        </li>

                        <li>                
                            <input type="button" name="btLoginGoogleGrande" value="Cadastre-se com o Google" class="login_botao_google" onclick="fn_chamalogin(this)"/>
                        </li>
        ...
        <div id="div_login_cadastro" class="login_box_cadastro" > 
            ...
            <div class="login_botoes_pequeno" id="div_login_botoes_pequeno" style="display:none">
             <ul>
                ...
                <li>                
                    <input type="button" name="btLoginFacebookPequeno" value="Cadastre-se com o Facebook" class="login_botao_facebook" onclick="fn_chamalogin(this)"/>
                </li>

                <li>                
                    <input type="button" name="btLoginGooglePequeno" value="Cadastre-se com o Google" class="login_botao_google" onclick="fn_chamalogin(this)"/>
                </li>
        ...
        <div class="login_box_cadastro_campos" id="div_login_campos_cadastro" style="display:block">
...
<div class="login_termo_uso">
    <p>Ao efetuar o cadastro você concorda com os <a href="/portal/pdf/TERMOS_DE_USO_E_CONDICOES_DE_NAVEGACAO.pdf" target="blank">Termos de Serviço</a> do 1Acordo e a <a href="/portal/pdf/POLITICA_DE_PRIVACIDADE.pdf" target="blank"">Política de Privacidade</a>.</p>   
</div>

<div class="linha"></div>

<div id="login_rodape_fazlogin" class="login_rodape" style="display: none">
...
function fn_setaNomesBotoesLogin(divPai, bl_criar ){
    ...
    for ( var i =0; i < bts.length; i++){
       ...
       if ( bl_criar ){
        if ( botao.name.toLowerCase().indexOf("google") > 1 ){
            botao.value = "Cadastre-se com o Google";
        }
        ...
        if ( botao.name.toLowerCase().indexOf("facebook") > 1 ){
            botao.value = "Cadastre-se com o Facebook";
        }
       ...
       if ( botao.name.toLowerCase().indexOf("google") > 1 ){
        botao.value = "Entre com o Google";
    }
    if ( botao.name.toLowerCase().indexOf("twitter") > 1 ){
    ...
    if ( botao.name.toLowerCase().indexOf("facebook") > 1 ){
        botao.value = "Entre com o Facebook";
    }
    //if ( botao.name.toLowerCase().indexOf("email") > 1 ){
        //botao.value = "Criar conta usando Email";
