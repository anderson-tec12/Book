 ...
 */
	...
	$client->client_id = $auth_config["facebook_client_id"]; $application_line = __LINE__;
	$client->client_secret = $auth_config["facebook_client_secret"];
        
        
        /*

            //uses the PHP SDK.  Download from https://github.com/facebook/php-sdk
            require_once('facebook-sdk/Facebook/autoload.php');
            require_once('facebook-sdk/Facebook/Facebook.php');
//facebook-sdk\Facebook
            $facebook = new Facebook\Facebook(array(
              'app_id'  => $auth_config["facebook_client_id"],
              'app_secret' => $auth_config["facebook_client_secret"],
            ));
        ...
        */
        ...
        $url = 'https://www.facebook.com/v2.3/dialog/oauth?client_id='.$client->client_id.
                '&redirect_uri='.urlencode($client->redirect_uri).'&scope=email&state=1';
        //echo( $url );die(" -- ");
...
*/
	...
	if($success)
	{
          ...
          // print_r( $user );
           // die("pare aqui por favor!");
                 
           if ( $auth_config["redireciona"] ){
			$nome_session = $auth_config["session_name"];
			
			$_SESSION[  $nome_session   ] = $user;
			$_SESSION[  $nome_session  ."_tipo" ] = "facebook";
			header("Location: ".$auth_config["url_redir"]);
			die("");
		 }
