...
//	$client->redirect_uri = 'oob';
	...
	$client->client_id = $auth_config["twitter_client_id"]; $application_line = __LINE__;
	$client->client_secret = $auth_config["twitter_client_secret"];
	...
	if($success)
	{
		 ...
		 if ( $auth_config["redireciona"] ){
			...
			$_SESSION[  $nome_session   ] = $user;
		        $_SESSION[  $nome_session  ."_tipo" ] = "twitter";
