...
| -------------------------------------------------------------------*/
	...
	//D:\OpenServers\apache_php5\www\editor_html\imgusuario
	$config['img_path'] = K_TMCE_ABSOLUTE_IMG; // '/editor_html/imgusuario'; // Relative to domain name
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . $config['img_path']; // Physical path. [Usually works fine like this]
	//$config['upload_path'] = K_TMCE_PATH_IMG; // $_SERVER['DOCUMENT_ROOT'] . $config['img_path']; // Physical path. [Usually works fine like this]
