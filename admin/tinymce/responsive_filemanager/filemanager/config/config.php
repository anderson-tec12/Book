...
|    |   |   |   |   |- plugin.min.js
*/
//echo( K_TMCE_PATH_IMG_RELATIVE_FILEGER );
...
$config = array(
	...
	*/
	...
	in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'],
	...
	|
	*/
	'upload_dir' => K_TMCE_ABSOLUTE_IMG ."/",
	...
	|
	*/
	'current_path' => K_TMCE_PATH_IMG_RELATIVE_FILEGER ."/",
