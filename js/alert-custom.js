...
;(function(window, document) {
   ...
   */
  window.sweetAlert = window.alerta = function() {
   ...
   */
  window.sweetAlert.closeModal = window.alerta.closeModal = function() {
    closeModal();
  };
  ...
  function modalDependant() {
    ...
    switch (typeof arguments[0]) {
      ...
      case 'object':
         ...
         */
        window.sweetAlert.callback = window.alerta.callback = function(isConfirm) {
    ...
    window.alerta.toggleLoading = function() {
      $confirmButton.disabled = !$confirmButton.disabled;
      $cancelButton.disabled = !$cancelButton.disabled;
    };

    window.alerta.enableButtons = function() {
      $confirmButton.disabled = false;
      $cancelButton.disabled = false;
    };

    window.alerta.disableButtons = function() {
      $confirmButton.disabled = true;
      $cancelButton.disabled = true;
    };

    alerta.enableButtons();
   ...
   */
  window.alerta.setDefaults = function(userParams) {
    if (!userParams) {
