 ...
 */
var sweetAlert, alerta;

sweetAlert = alerta = function () {
 ...
 */
sweetAlert.setDefaults = alerta.setDefaults = function (userParams) {
  if (!userParams) {
 ...
 */
sweetAlert.close = alerta.close = function () {
  var modal = _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
 ...
 */
sweetAlert.showInputError = alerta.showInputError = function (errorMessage) {
  var modal = _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
 ...
 */
sweetAlert.resetInputError = alerta.resetInputError = function (event) {
...
if (typeof window !== 'undefined') {
  ...
  window.sweetAlert = window.alerta = sweetAlert;
} else {
