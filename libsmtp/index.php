    ...
    if ( $acao == "cadastro" ){
            ...
            if ( $bl_ok ){
                    ...
                    if (!$usuario["id"]){
                            ...
                            $msg_dados = "<div class='mensagem'> Obrigado por se cadastrar. Um e-mail de confirmação foi enviado para " . $usuario["email"]. ", é necessário
                                               ativar a sua conta através do link enviado por e-mail. </div> ";
                 ...
                 if (! $usuario["verificado_email"] ){
                     ...
                     if ( $usuario["senha"] == "" ){
                         ...
                         if ( $bol_sub_ok ){ //Login Correto.
                             ...
                             $_SESSION["st_Mensagem"] = "Login realizado com sucesso!";
                             header("Location: mensagem.php");
                             die("");
