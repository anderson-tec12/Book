...
$from="sistemas@ufcengenharia.com.br";                           /* Change this to your address like "me@mydomain.com"; */ $sender_line=__LINE__;
	$to="rafaelrend@gmail.com";                             /* Change this to your test recipient address */ $recipient_line=__LINE__;
    ...
    $smtp->host_name='mail.ufcengenharia.com.br';       /* Change this variable to the address of the SMTP server to relay, like "smtp.myisp.com" */
...
$smtp->user='sistemas@ufcengenharia.com.br';/* Set to the user name if the server requires authetication */
	$smtp->realm="";                    /* Set to the authetication realm, usually the authentication user e-mail domain */
$smtp->password='ufcsistemas';                 /* Set to the authetication password */
