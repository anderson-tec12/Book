         ...
         if ( $codigo_teste == $codigo_verificacao ){
                       ...
                       if ( $convite_id != "" ){
                           ...
                           if ( is_array( @$_SESSION["st_MsgMetadados"] ) ){
                               ...
                               if ( @$_SESSION["st_MsgMetadados"]["tipo_convite"] != "" ){
                                   $tipo_convite = $_SESSION["st_MsgMetadados"]["tipo_convite"];
                               }
                           }
                           
                           if ( Util::request("tipo_convite") != "" ){
                               $tipo_convite = Util::request("tipo_convite");
                           }
                           
                          // print_r( $_SESSION["st_MsgMetadados"] ); die (" -- ". $tipo_convite);
                           
                            ticket::adicionaParticipante($oConn, $convite_id, $usuario["id"], $tipo_convite);  
                            SessionCliente::setValorSessao("convite_id", $convite_id);
                            SessionCliente::setValorSessao("convidado_por", $convidado_por );

                            $pagina_include = "inc_convidado_primeiro_acesso_email"; //Convidado
                            
                            if ( $tipo_convite == "antagonista" ){ // Antagonista..
                                $pagina_include = "inc_painel_controle_home";
                            }
                            SessionCliente::setValorSessao("include", $pagina_include);
                            
                            SessionCliente::setMensagem("#origem:convite|#convidado_por:". $convidado_por.
                                    "|#include:".$pagina_include."|#convite_id:" . $convite_id);
                            ...
                            acao_ticket::gravaLog( $usuario["nome_completo"]. " aceitou o convite - ". $tipo_convite ,
                                       "Convite", "Convite","convite", 
                                       $id_ticket, $usuario["id"], $id_ticket, "ticket", 
                                       "Convidado por". $convidado_por, "");
                       }
                       
                       header("Location:". K_URL_PAINEL );
                       $oConn->disconnect();
                       die("redireciona");
...
<div id="campo">
    ...
    <div class="mensagem">
        <table align="center" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><a href="http://possivelacordo.com.br/portal/" target="_top"><img class="logo_mensagem" src="../mensagem/images/logo_mensagem.png"/></a></td>
            </tr>
            ...
            <tr>
              <td><a class="bt_portal button" href="http://possivelacordo.com.br/portal/">Portal</a></td>
            </tr>
